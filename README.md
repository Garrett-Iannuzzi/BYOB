...
|  **Post new title to metro area** | /api/v1/titles/:metro_id/titles  |  POST |  **New title:** ```{ year: 2021, level: 'pro', sport: 'NFL', 'winner: 'Denver Broncos', title_metro: 'Denver, CO', metro_id: 21164 }``` |  **New title:** ```{ "id": 4236779, "year": 2021, "level": "pro", "sport": null, "winner": "Denver Broncos", "title_metro": "Denver, CO","metro_id": 21164 }```
|   |   |  DELETE |   |   |
